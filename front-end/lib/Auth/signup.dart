...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future<void> addStudent() async {
    ...
    final Uri uri = Uri.parse('https://asur-ams.vercel.app/api/PostSignUpDetails');
    final Map<String, dynamic> data = {
      'FirstName':
          firstName, // Modify the keys to match the API's expected keys
      'LastName': lastName,
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData['success'] == true) {
          ...
          print(' free attendance attendance marked Successfully');
        } else {
  ...
  Future<void> markAttendance(String rollNo) async {
    final url = Uri.parse('https://asur-ams.vercel.app/api/MarkDefaultAttendance'); // Replace with your server's endpoint.
                    ...
                    ? ClipRect(
                        child: Align(
                          alignment: FractionalOffset(
                              0.5, -0.35), // Adjust the offset here
                          child: Container(
                            height:
                                height * 0.5, // Display only half of the image
                            child: Stack(
                              children: [
                                Column(
                                  children: [
